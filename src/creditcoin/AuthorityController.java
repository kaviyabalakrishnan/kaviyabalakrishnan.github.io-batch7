...
public class AuthorityController implements Initializable {
    ...
    @FXML
    public TableView<Table1> Table;
    @FXML
    public TableColumn<Table1, String> Nodename;
    @FXML
    public TableColumn<Table1, String> PortNo;
    @FXML
    public TableColumn<Table1, String> Id;
 @FXML
    public TableColumn<Table2, String> Signal;
    @FXML
   public ObservableList<Table1> pathinfodata;
    @FXML
    public Label RsuNum;
   ...
   static Random r=new Random();
     static int id=r.nextInt(9999);
     
  public static String auid = Integer.toString(id);
String rsu=nn.rsun();;
    String Name;
 ...
 public Vector allnode = new Vector();
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        ...
        sr = new SingleReceiver(auid, portnumber, sysnumber, this);
       
        mr = new MultiReceiver(auid, portnumber, sysnumber, AuthorityController.this);

      
        portno.setText(portnumber);
        ID.setText(auid);
       pathinfodata = FXCollections.observableArrayList(new Table1());
       
        Nodename.setCellValueFactory(new PropertyValueFactory<Table1, String>("Nodename"));
        PortNo.setCellValueFactory(new PropertyValueFactory<Table1, String>("Portno"));
        Id.setCellValueFactory(new PropertyValueFactory<Table1, String>("Id"));

        Table.setItems(pathinfodata);
        Table.getColumns().setAll(Nodename, PortNo, Id);
        ...
        multisender1.getKeyFrames().add(new KeyFrame(Duration.seconds(2), new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if (!latitude.getText().toString().isEmpty()) {
                    ...
                    //  ms = new MultiSender(Name, portnumber, sysnumber, xVal, yVal, AuthorityController.this);
                    ms = new MultiSender(auid, portnumber, sysnumber, xVal, yVal, AuthorityController.this);
                    ...
                    if (NodeStatus.map.containsKey(Name)) {
                        ...
                        hashMap.put("YMIN", yPosition - 2000);
                        hashMap.put("YMAX", yPosition + 2000);
...
//                        hashMap.put("YMAXCRI", yPosition + 35);
                        ...
                        NodeStatus.map.put(Name, hashMap);
                        hashMap = NodeStatus.map.get(Name);
...
//                                            }
                                ...
                                neighbor.put(Name, neigh);
                            }
                        } else if (v.contains(name)) {
                            v.remove(name);
                            neighbor.remove(Name, neigh);
